...
*/
export class SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsShipperDetails {
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "typeCode",
            "baseName": "typeCode",
            "type": "SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsShipperDetailsTypeCodeEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsShipperDetails.attributeTypeMap;
    }
...
export type SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsShipperDetailsTypeCodeEnum = "business" | "direct_consumer" | "government" | "other" | "private" | "reseller" ;
