...
*/
export class SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsPayerDetails {
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "typeCode",
            "baseName": "typeCode",
            "type": "SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsPayerDetailsTypeCodeEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsPayerDetails.attributeTypeMap;
    }
...
export type SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsPayerDetailsTypeCodeEnum = "business" | "direct_consumer" | "government" | "other" | "private" | "reseller" ;
