...
import { SupermodelIoLogisticsExpressAddressRatesRequest } from './SupermodelIoLogisticsExpressAddressRatesRequest';
import { HttpFile } from '../http/http';

/**
* Here you need to define all the parties needed to ship the package
*/
export class SupermodelIoLogisticsExpressLandedCostRequestCustomerDetails {
    ...
    static getAttributeTypeMap() {
        return SupermodelIoLogisticsExpressLandedCostRequestCustomerDetails.attributeTypeMap;
    }
