...
export class SupermodelIoLogisticsExpressPickupRequestCustomerDetailsShipperDetails {
    ...
    static getAttributeTypeMap() {
        return SupermodelIoLogisticsExpressPickupRequestCustomerDetailsShipperDetails.attributeTypeMap;
    }
