...
*/
export class SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsExporterDetails {
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "typeCode",
            "baseName": "typeCode",
            "type": "SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsExporterDetailsTypeCodeEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsExporterDetails.attributeTypeMap;
    }
...
export type SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsExporterDetailsTypeCodeEnum = "business" | "direct_consumer" | "government" | "other" | "private" | "reseller" ;
