...
*/
export class PickupPickupDetails {
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "typeCode",
            "baseName": "typeCode",
            "type": "PickupPickupDetailsTypeCodeEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return PickupPickupDetails.attributeTypeMap;
    }
...
export type PickupPickupDetailsTypeCodeEnum = "business" | "direct_consumer" | "government" | "other" | "private" | "reseller" ;
