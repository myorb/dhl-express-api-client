...
*/
export class SupermodelIoLogisticsExpressUploadInvoiceDataRequestCustomerDetailsSellerDetails {
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "typeCode",
            "baseName": "typeCode",
            "type": "SupermodelIoLogisticsExpressUploadInvoiceDataRequestCustomerDetailsSellerDetailsTypeCodeEnum",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return SupermodelIoLogisticsExpressUploadInvoiceDataRequestCustomerDetailsSellerDetails.attributeTypeMap;
    }
...
export type SupermodelIoLogisticsExpressUploadInvoiceDataRequestCustomerDetailsSellerDetailsTypeCodeEnum = "business" | "direct_consumer" | "government" | "other" | "private" | "reseller" ;
